...
includes a compact C11 port of dearxan v0.5.6. Its before-main scheduling follows
...
| `patch_mem_dedicated_heap` | `1` | Reserve a dedicated high-address mimalloc arena instead of using the regular mimalloc heap. |
